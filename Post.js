...
import { shader as orthoVertexShader } from "./shaders/post/ortho.js";
import { ShaderPass } from "three/examples/jsm/postprocessing/ShaderPass";
import { BloomPass } from "three/examples/jsm/postprocessing/BloomPass";
import { shader as vignette } from "./shaders/post/vignette.js";
import { shader as noise } from "./shaders/post/noise.js";
import { shader as screen } from "./shaders/post/screen.js";
import { shader as chromaticAberration } from "./shaders/post/chromatic-aberration.js";
...
class Post {
  constructor(renderer, params = {}) {
    ...
    this.colorFBO = getFBO(512, 512, {}, supersampled);
  ...
  render(scene, camera) {
    ...
    // this.colorPass.material.uniforms.inputTexture.value = this.colorFBO.texture;
